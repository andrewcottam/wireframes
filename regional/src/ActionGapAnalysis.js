...
class ActionGapAnalysis extends React.Component {
  state = {
    finished: false,
    stepIndex: 0,
  };
    ...
    return (
      <div style={{width: '100%', maxWidth: 700, margin: 'auto',textAlign:'center'}}>
        <Stepper activeStep={stepIndex}>
          <Step>
            <StepLabel>Select your species</StepLabel>
          </Step>
          <Step>
            <StepLabel>Select your protected areas</StepLabel>
          </Step>
        </Stepper>
        <div style={contentStyle}>
          ...
          <MenuItem value={1} primaryText="WDPA August 2017" />
          <MenuItem value={2} primaryText="Local marine managed areas" />
          <MenuItem value={3} primaryText="All protected areas" />
        </DropDownMenu> : null}
...
export default ActionGapAnalysis;
