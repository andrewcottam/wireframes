    ...
    if (this.props.indicator) {
      switch (this.props.indicator.indicatorListItem.props.primaryText) {
        ...
        case 'Terrestrial protected area coverage':
          this.props.map.setStyle('mapbox://styles/blishten/cjckavkjc9xui2snvo09hqpfs'); //terrestrial style
        ...
        case 'Marine protected area coverage':
          ...
          this.props.map.setCenter([39.554, -7.602]);
          this.props.map.zoomTo(7);
          break;
        default:
      }
    }
