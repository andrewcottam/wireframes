...
class MapToolbar extends React.Component {
    ...
    render() {
        return (
            ...
            <div className="grid">
                <button type="button" className="btn" onClick={this.zoomIn.bind(this)}>
                    <svg role="presentation" focusable="false" className="events-none icon" style={{width: '18px',height: '18px'}}>
                ...
                <button type="button" className="btn">
                    <span className="block" style={{transform: 'rotate(0deg)'}}>
                        <svg role="presentation" focusable="false" className="events-none icon" style={{width: '18px',height: '18px'}}>
                ...
                <button type="button" className="btn" style={{borderRightWidth: '0px'}}>
                    <svg role="presentation" focusable="false" className="events-none icon" style={{width: '18px', height: '18px'}}>
