...
class IndicatorsDrawer extends React.Component {
    render() {
        ...
        const indicators = this.props.indicators && this.props.indicators.map((indicator) => {
            return <IndicatorListItem {...this.props} desc={indicator.props.desc} primaryText={indicator.props.primaryText} id={indicator.props.id} key={indicator.props.primaryText} iso3={indicator.props.iso3} secondaryText={indicator.props.secondaryText} onClick={this.props.indicatorSelected}/>;
        });
        return (
            <React.Fragment>
