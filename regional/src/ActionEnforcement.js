...
class ActionEnforcement extends React.Component {
  state = {
    finished: false,
    stepIndex: 0,
  };
    ...
    return (
      <div style={{width: '100%', maxWidth: 700, margin: 'auto',textAlign:'center'}}>
        <Stepper activeStep={stepIndex}>
          <Step>
            <StepLabel>Select the enforcement agency</StepLabel>
          </Step>
          <Step>
        ...
        <div style={contentStyle}>
          ...
          <MenuItem value={1} primaryText="person1@scarymob.com" />
          <MenuItem value={2} primaryText="person2@scarymob.com" />
        </DropDownMenu> : null}
...
export default ActionEnforcement;